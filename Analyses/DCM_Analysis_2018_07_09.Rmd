...
library(dplyr)
data.dir <- file.path("/Users/kevinoconnor/Documents/Research/DCM/Data/7_9_18")
```
...
# Get initial set.
load(file.path(data.dir, "alt_Initialization_125.RData"))
...
no_output <- lapply(1:5, function(i){
  ...
  load(file.path(data.dir, paste0("alt_DCM_", i, "_125.RData")))
