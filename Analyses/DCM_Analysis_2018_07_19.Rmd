---
title: "Microarray DCM Analysis LumA vs. LumB"
...
This document contains results from running DCM on the LumA and LumB microarray data from Di Wu.
...
# Get initial set.
load(file.path(data.dir, "Initialization.RData"))
