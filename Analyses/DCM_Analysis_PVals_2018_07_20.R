# TITLE: DCM_Analysis_PVals_2018_07_20.R
# AUTHOR: Kevin O'Connor
# DATE CREATED: 7/20/18
# DATE MODIFIED: 7/20/18
...
library(dplyr)
data.dir <- file.path("/Users/kevinoconnor/Documents/Research/DCM/Data/2018_07_17 11_11_36/Debug_Output")

# Collect data from each search.
p_vals_l_l <- lapply(1:3, function(i){
