...
library(dplyr)
data.dir <- file.path("/Users/kevinoconnor/Documents/Research/DCM/Test/2018_08_03 16:33:16/Debug_Output")
```

RNAseq data with rows normalized.
...
no_output <- lapply(1:4, function(i){
